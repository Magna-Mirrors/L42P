...
Namespace UI.Views.Calibration.SubViews
    Public Class TesterDevicesUserControl
        ...
        Private ReadOnly Property NestAddr As String
            Get
                Return $"{Tag_TesterAddress}.Nest{_data.NestId}"
            End Get
        End Property
...
#Region "Other"
        ...
        Private Sub Btn_MouseDown(sender As Object, e As EventArgs) Handles BtnHale.MouseDown, BtnGi.MouseDown
            If sender Is BtnHale Then
                RaiseSaved(GetManualAddr("Clamps"), (_data.ManualOps.Clamps Or 16))
            ElseIf sender Is BtnGi Then
                RaiseSaved(GetManualAddr("Gi"), (_data.ManualOps.Gi Or 2))

            End If
        End Sub
        Private Sub Btn_MouseUp(sender As Object, e As EventArgs) Handles BtnHale.MouseUp, BtnGi.MouseUp
            If sender Is BtnHale Then
                RaiseSaved(GetManualAddr("Clamps"), (_data.ManualOps.Clamps And Not 16))
            ElseIf sender Is BtnGi Then
