...
Namespace UI.Views.Calibration
    ...
    Public Class ViewCalibration
        ...
        Public Sub New(langWatch As ILanguageWatch, cfg As ICfgNonDomino, userWatch As IUserWatch, plc As IPlc, msgsvc As IMessageAlertService, plcrepo As IPlcFullRepo)
        ...
        Private Shared Function NestAddress(nestid As Integer) As String
            Return $"{Tag_TesterAddress}.Nest{nestid}"
        End Function
            ...
            Try
                If _tester IsNot Nothing Then
                    ...
                    If {1, 2}.Contains(SelectedNestId) Then
                        ...
                        End If
                        Dim cfg As NonDominoCfg = _cfg.ReadConfig()
