...
Namespace UI.Views.Settings
    ...
    Public Class ApplicationSettingsView
        ...
        Public Sub New(cfg As ICfgNonDomino, plc As IPlc, userWatch As IUserWatch, msgsvc As IMessageAlertService, scheduleServiceFactory As ScheduleServiceFactory)
            MyBase.New()
            _cfg = cfg
            ...
            InitializeComponent()
            ShiftSetup1.AddDependencies(scheduleServiceFactory)
