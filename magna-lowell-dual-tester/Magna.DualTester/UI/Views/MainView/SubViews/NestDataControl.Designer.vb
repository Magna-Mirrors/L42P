...
Namespace UI.Views.MainView.SubViews
    ...
    Partial Class NestDataControl
        ...
        Private Sub InitializeComponent()
            ...
            Me.NestPartOptions1 = New DualTester.NestPartOptions()
            Me.NestOptionsUserControl1 = New DualTester.UI.Views.MainView.SubViews.NestOptionsUserControl()
            ...
            '
            Me.MirrorMotionItemBindingSource.DataSource = GetType(DualTester.UI.Views.MainView.SubViews.MirrorMotionItem)
            '
            'NestDataControl
            '
