...
Public Class AsTest
    ...
    Public Function Test(asc As IPlc) As IEnumerable(Of IUdtTest) Implements IAsTest.Test
        ...
        results.Add(SendRead(Of Udt_GlassOptions)(Combine(TagUdt_partInformation, "GlassOptions"), asc))
        results.Add(SendRead(Of Udt_PartInformation)(TagUdt_partInformation, asc))
        ...
        results.Add(SendRead(Of Udt_Printer)(Tester + ".Printer", asc))
        results.Add(SendRead(Of Udt_tester)(Tester, asc))

        Dim passed = results.Where(Function(x) x.Success)
        Dim failed = results.Where(Function(x) Not x.Success)
        Dim finalResults = results.Select(Function(x) x)
    ...
    Public Async Function TestAsync(asc As IPlc) As Task(Of IEnumerable(Of IUdtTest)) Implements IAsTest.TestAsync
        ...
        Dim results = New List(Of Task(Of IUdtTest))()

        results.Add(SendReadAsync(Of Udt_Color)(TagUdt_Color, asc))
        results.Add(SendReadAsync(Of Udt_Colors)("Colors", asc, 32))
        results.Add(SendReadAsync(Of Udt_AlgItem)(TagUdt_AlgItem, asc))
        results.Add(SendReadAsync(Of Udt_AnalogItems)(TagUdt_AnalogItems, asc))
        results.Add(SendReadAsync(Of Udt_Mcal)(TagUdt_Mcal, asc))
        results.Add(SendReadAsync(Of Udt_PartOptions)(TagUdt_PartTestOptions, asc))
        results.Add(SendReadAsync(Of Udt_Logvalues)(TagUdt_Logvalues, asc))
        results.Add(SendReadAsync(Of Udt_Manual_Operators)(TagUdt_ManualOp, asc))
        results.Add(SendReadAsync(Of Udt_Scale)(TagUdt_Scale, asc))
        results.Add(SendReadAsync(Of Udt_Opt_Item)(TagUdt_Opt_Item, asc))
        results.Add(SendReadAsync(Of Udt_LogItem)(TagUdt_LogItem, asc))
        results.Add(SendReadAsync(Of Udt_Nest)(TagUdt_Nest, asc))
        results.Add(SendReadAsync(Of Udt_HeartBeat)(TagUdt_HeartBeat, asc))
        results.Add(SendReadAsync(Of Udt_LgBuffCntrl)(TagUdt_LgBuffCntrl, asc))
        results.Add(SendReadAsync(Of Udt_GlassOptions)(Combine(TagUdt_partInformation, "GlassOptions"), asc))
        results.Add(SendReadAsync(Of Udt_PartInformation)(TagUdt_partInformation, asc))
        results.Add(SendReadAsync(Of Udt_MinMax)(TagUdt_minMax, asc))
        results.Add(SendReadAsync(Of Udt_Setpoints)(TagUdt_Setpoints, asc))
        results.Add(SendReadAsync(Of Udt_Tester_Counts)(TagUdt_Tester_Counts, asc))
        results.Add(SendReadAsync(Of Udt_LogReq)(TagUdt_LogReq, asc))
        results.Add(SendReadAsync(Of Udt_UserStatus)(TagUdt_User_Status, asc))
        results.Add(SendReadAsync(Of Udt_User)(TagUdt_User, asc))
        results.Add(SendReadAsync(Of Udt_Activity)(Combine(Tester, "ActivityLogQueItem"), asc))
        results.Add(SendReadAsync(Of Udt_Printer)(Combine(Tester, "Printer"), asc))
        results.Add(SendReadAsync(Of Udt_tester)(Tester, asc))
    ...
    ReadOnly Tester As String = My.Resources.Tag_TesterAddress
    '----------------------------------------------------------------------------
    ...
    ReadOnly TagUdt_partInformation As String = Combine(Tester, "PartInfo")
