            ...
            Try
                ...
                If _vm IsNot Nothing Then
                    With _vm.AlgFeatures
                        ...
                        'BtnMirrorAngle.Enabled = compair(alg.HorzAngle.AnalogInDint, alg.HorzAngle.MinRawCalDeflect)
                        'BtnZero.Enabled = compair(alg.HorzAngle.AnalogInDint, alg.HorzAngle.MinRawCalDeflect)
                        ...
                        BtnHeater.Enabled = compair(.DefogAmp.AnalogInDint, .DefogAmp.MinRawCalDeflect) AndAlso _isEngieOrBetter
                        BtnTurnSig.Enabled = compair(.Ts_Amp.AnalogInDint, .Ts_Amp.MinRawCalDeflect) AndAlso _isEngieOrBetter
                        'BtnGi.Enabled = compair(.Gi_Amp.AnalogInDint, .Gi_Amp.MinRawCalDeflect) AndAlso _isEngieOrBetter
                        BtnPFold.Enabled = compair(.Pf_Amp.AnalogInDint, .Pf_Amp.MinRawCalDeflect) AndAlso _isEngieOrBetter
                        'BtnBzi.Enabled = compair(.Bzi_Amp.AnalogInDint, .Bzi_Amp.MinRawCalDeflect) AndAlso _isEngieOrBetter
